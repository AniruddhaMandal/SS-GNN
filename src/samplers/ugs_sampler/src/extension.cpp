...
PYBIND11_MODULE(ugs_sampler, m) {
    ...
    m.def("sample", &sample, py::arg("handle"), py::arg("m_per_graph"), py::arg("k"), py::arg("edge_mode")="local", py::arg("base_offset")=0, py::arg("seed")=42,
    ...
    m.def("sample_batch", &sample_batch, py::arg("edge_index"), py::arg("ptr"), py::arg("m_per_graph"), py::arg("k"), py::arg("mode")="sample", py::arg("seed")=42,
