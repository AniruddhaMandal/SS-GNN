...
@register_model('VANILLA-GINE')
def VANILLA_GINE(cfg: ExperimentConfig):
    from gps.models.vanilla_gine import GINEClassifier   
    model = GINEClassifier(in_channels=cfg.model_config.node_feature_dim,
